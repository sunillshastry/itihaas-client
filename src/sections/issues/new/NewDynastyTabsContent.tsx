...
import newDynastyFields from '@/data/issues/newDynastyFields';

export default function NewDynastyTabsContent() {
	return (
		<>
			<TabsContent value="dynasty">
				<div className="border-primary-70/35 border-b pb-2">
					<h3 className="text-xl font-medium">New Dynasty</h3>
				...
				<div>
					{newDynastyFields.map(function (field) {
						if (field.type === 'input') {
							return (
								<InputFormControl
									key={field.id}
