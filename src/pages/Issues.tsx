				...
				<div className="text-primary-400 mt-5">
					...
					<div>
						...
						>
							...
							sub-fields within existing entities (dynasty, ruler and war), or
							add new entity (dynasty, ruler, war) or suggest new historical
							entities that are not yet available on the platform. We welcome
							well researched submissions that enhance our coverage of regional
							or lesser known historical narratives, ensuring a more inclusive
							and comprehensive resource for all users. Your submission will be
							reviewed by our team, and if approved, added to our growing
							dataset.
						</IssueTypeLink>
						...
						>
							...
							rulers, wars, or any other published entity. We strive to ensure
							all historical data is factual, consistent, and accessible. Your
							reports help us fix issues quickly and maintain the integrity of
							the platform.
						</IssueTypeLink>
						...
						<IssueTypeLink
							...
							to="api"
						>
							This form is for developers, researchers, or users interacting
							with our public API. Whether you're running into bugs, facing
						...
						<IssueTypeLink
							...
							to="feedback"
						>
							If you'd like to leave a comment, share a new feature idea,
							provide feedback on usability, or even just tell us what you think
							about the project, this form is for you. Whether it's praise,
							constructive criticism, or curious questions, we value every
							message and use it to inform the ongoing development of the
							platform.
						</IssueTypeLink>
					</div>
				</div>
