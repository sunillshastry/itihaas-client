				...
				<div className="text-primary-400 mt-5">
					...
					<div>
						<IssueTypeLink
							...
							to="new"
						>
							Use this form if you'd like to propose the addition of sub-fields
							within existing entities (dynasty, ruler and war), or add new
							entity (dynasty, ruler, war) or suggest new historical entities
